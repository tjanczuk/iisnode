...
exports.streamFile = function (filepath, headerFields, stat, res, req, emitter) {
    ...
    process.nextTick(function () {
        //console.log('PAPERBOY START ' + filepath);
        ...
        if (statCode == 304 || req.method === 'HEAD') {
            //console.log('PAPERBOY CLOSE WITH 304 ' + filepath);
            res.end();
        ...
        .addListener("data", function (chunk) {
            //console.log('PAPERBOY WRITE CHUNK ' + filepath);
            res.write(chunk, 'binary');
        })
        .addListener("end", function () {
            //console.log('PAPERBOY END ' + filepath);
            emitter.emit("success", statCode);
        })
        .addListener("close", function () {
            //console.log('PAPERBOY CLOSE ' + filepath);
            res.end();
        })
        .addListener("error", function (e) {
            //console.log('PAPERBOY ERROR ' + filepath + ': ' + e);
